...
function [xs, us, alpha] = transition_compute_ss_ADMM_old(x0, N, paramBefore, paramAfter, target)
    rho = 0.25;
    TMAX = 100;
    Tk = 0; k = 2; l=1;
...
function [w_Ni, vi] = local_optim(i, x0, N, paramBefore, paramAfter, z_Ni, y_Ni, rho, target)
    objective_i = 0;
    constraints_i = [];
    ni = paramBefore.ni;
    nu = paramBefore.nu;
