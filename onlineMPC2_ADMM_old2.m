function u0 = onlineMPC2_ADMM_old2(x0,Q_Ni, Ri, N, param)
    rho = 0.25;
    TMAX = 40;
    Tk = 0; k = 2; l=1;
...
function [w_Ni, vi] = local_optim(i,x0, Q_Ni, Ri, N, param, z_Ni, y_Ni, rho)
    ...
    localOptimizer = init_optimizer(i,Q_Ni, Ri, N, param, z_Ni, y_Ni, rho);
                                
    solutionSet = localOptimizer(x0);
...
function localOptimizer = init_optimizer(i, Q_Ni, Ri, N, param, z_Ni, y_Ni, rho)
    objective_i = 0;
    constraints_i = [];
