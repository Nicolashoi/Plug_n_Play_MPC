function [xs, us] = transition_compute_ss_ADMM_new(x0,N, paramBefore, paramAfter,...
                                             target)
    rho = 0.25;
    TMAX = 40;
    Tk = 0; k = 2; l=1;
...
function localOptimizer = init_optimizer(x0, i, N, paramBefore, paramAfter, rho, target)
   objective_i = 0;
    ...
    n_Ni_before = size(paramBefore.A_Ni{i},2); % size of Neighbors set before PnP
   ...
   % Variables for 2nd optimization part (DGU PnP active and connected to
    ...
    constraints_i = [constraints_i, Uei == paramAfter.Ki{i}*Xei + di];  % new redesigned gains
    ...
    %% 2nd Optimization Part: Plug In/out and Terminal Set constraints
